...
LABEL ca.unb.lib.generator="mysql" \
      ...
      org.label-schema.description="ospos.mysql.lib.unb.ca provides database storage for Point-Of-Sale transactions at UNB Libraries." \
      org.label-schema.name="ospos.mysql.lib.unb.ca" \
