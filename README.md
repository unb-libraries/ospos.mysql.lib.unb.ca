# ospos.mysql.lib.unb.ca : Instance Repository
[![Build Status](https://travis-ci.com/unb-libraries/lib.unb.ca.svg?branch=prod)](https://travis-ci.com/unb-libraries/ospos.mysql.lib.unb.ca) [![GitHub license](https://img.shields.io/github/license/unb-libraries/ospos.mysql.lib.unb.ca)](https://github.com/unb-libraries/ospos.mysql.lib.unb.ca/blob/dev/LICENSE) ![GitHub repo size](https://img.shields.io/github/repo-size/unb-libraries/ospos.mysql.lib.unb.ca)

This repository contains all assets used to test, build, and deploy the ospos.mysql.lib.unb.ca database server, the database that drives [pos.lib.unb.ca](https://pos.lib.unb.ca).
...
## Author / Licensing
- Developed by [![UNB Libraries](https://github.com/unb-libraries/assets/raw/master/unblibbadge.png "UNB Libraries")](https://ospos.mysql.lib.unb.ca/)
